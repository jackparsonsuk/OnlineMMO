...
import { DUNGEON_ROOM_NAME, fishingProblems, OSTRA_IDS, roadProblems, ROOM_NAME, seaProblems, settlementProblems, unsafeElites, unsafeSpawns } from "@mmo/shared";
...
for (const problem of roadProblems()) {
  console.warn(`[road] ${problem}`);
}
